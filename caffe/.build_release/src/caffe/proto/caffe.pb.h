...
enum LayerParameter_ConnectivityMode {
  LayerParameter_ConnectivityMode_CONNECTED = 0,
  LayerParameter_ConnectivityMode_DISCONNECTED_ELTWISE = 1,
  LayerParameter_ConnectivityMode_DISCONNECTED_GRPWISE = 2
};
bool LayerParameter_ConnectivityMode_IsValid(int value);
const LayerParameter_ConnectivityMode LayerParameter_ConnectivityMode_ConnectivityMode_MIN = LayerParameter_ConnectivityMode_CONNECTED;
const LayerParameter_ConnectivityMode LayerParameter_ConnectivityMode_ConnectivityMode_MAX = LayerParameter_ConnectivityMode_DISCONNECTED_GRPWISE;
const int LayerParameter_ConnectivityMode_ConnectivityMode_ARRAYSIZE = LayerParameter_ConnectivityMode_ConnectivityMode_MAX + 1;

const ::google::protobuf::EnumDescriptor* LayerParameter_ConnectivityMode_descriptor();
inline const ::std::string& LayerParameter_ConnectivityMode_Name(LayerParameter_ConnectivityMode value) {
  return ::google::protobuf::internal::NameOfEnum(
    LayerParameter_ConnectivityMode_descriptor(), value);
}
inline bool LayerParameter_ConnectivityMode_Parse(
    const ::std::string& name, LayerParameter_ConnectivityMode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<LayerParameter_ConnectivityMode>(
    LayerParameter_ConnectivityMode_descriptor(), name, value);
}
...
enum ConvolutionParameter_ConvMode {
  ConvolutionParameter_ConvMode_LOWERED_GEMM = 0,
  ConvolutionParameter_ConvMode_LOWERED_CSRMM = 1,
  ConvolutionParameter_ConvMode_LOWERED_CCNMM = 2,
  ConvolutionParameter_ConvMode_DIRECT_SCONV = 3,
  ConvolutionParameter_ConvMode_DIRECT_DCONV = 4
};
bool ConvolutionParameter_ConvMode_IsValid(int value);
const ConvolutionParameter_ConvMode ConvolutionParameter_ConvMode_ConvMode_MIN = ConvolutionParameter_ConvMode_LOWERED_GEMM;
const ConvolutionParameter_ConvMode ConvolutionParameter_ConvMode_ConvMode_MAX = ConvolutionParameter_ConvMode_DIRECT_DCONV;
const int ConvolutionParameter_ConvMode_ConvMode_ARRAYSIZE = ConvolutionParameter_ConvMode_ConvMode_MAX + 1;

const ::google::protobuf::EnumDescriptor* ConvolutionParameter_ConvMode_descriptor();
inline const ::std::string& ConvolutionParameter_ConvMode_Name(ConvolutionParameter_ConvMode value) {
  return ::google::protobuf::internal::NameOfEnum(
    ConvolutionParameter_ConvMode_descriptor(), value);
}
inline bool ConvolutionParameter_ConvMode_Parse(
    const ::std::string& name, ConvolutionParameter_ConvMode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ConvolutionParameter_ConvMode>(
    ConvolutionParameter_ConvMode_descriptor(), name, value);
}
...
class SolverParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional float breadth_decay = 41 [default = 0];
  inline bool has_breadth_decay() const;
  inline void clear_breadth_decay();
  static const int kBreadthDecayFieldNumber = 41;
  inline float breadth_decay() const;
  inline void set_breadth_decay(float value);

  // optional float kernel_shape_decay = 42 [default = 0];
  inline bool has_kernel_shape_decay() const;
  inline void clear_kernel_shape_decay();
  static const int kKernelShapeDecayFieldNumber = 42;
  inline float kernel_shape_decay() const;
  inline void set_kernel_shape_decay(float value);

  // optional float block_group_decay = 43 [default = 0];
  inline bool has_block_group_decay() const;
  inline void clear_block_group_decay();
  static const int kBlockGroupDecayFieldNumber = 43;
  inline float block_group_decay() const;
  inline void set_block_group_decay(float value);

  // optional float special_shape_decay = 44 [default = 0];
  inline bool has_special_shape_decay() const;
  inline void clear_special_shape_decay();
  static const int kSpecialShapeDecayFieldNumber = 44;
  inline float special_shape_decay() const;
  inline void set_special_shape_decay(float value);
 ...
 private:
  ...
  inline void set_has_breadth_decay();
  inline void clear_has_breadth_decay();
  inline void set_has_kernel_shape_decay();
  inline void clear_has_kernel_shape_decay();
  inline void set_has_block_group_decay();
  inline void clear_has_block_group_decay();
  inline void set_has_special_shape_decay();
  inline void clear_has_special_shape_decay();
  ...
  float breadth_decay_;
  float kernel_shape_decay_;
  float block_group_decay_;
  float special_shape_decay_;
  int solver_type_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class ParamSpec : public ::google::protobuf::Message {
 public:
  ...
  // optional float breadth_decay_mult = 5 [default = 0];
  inline bool has_breadth_decay_mult() const;
  inline void clear_breadth_decay_mult();
  static const int kBreadthDecayMultFieldNumber = 5;
  inline float breadth_decay_mult() const;
  inline void set_breadth_decay_mult(float value);

  // optional float kernel_shape_decay_mult = 6 [default = 0];
  inline bool has_kernel_shape_decay_mult() const;
  inline void clear_kernel_shape_decay_mult();
  static const int kKernelShapeDecayMultFieldNumber = 6;
  inline float kernel_shape_decay_mult() const;
  inline void set_kernel_shape_decay_mult(float value);

  // optional float special_shape_decay_mult = 10 [default = 0];
  inline bool has_special_shape_decay_mult() const;
  inline void clear_special_shape_decay_mult();
  static const int kSpecialShapeDecayMultFieldNumber = 10;
  inline float special_shape_decay_mult() const;
  inline void set_special_shape_decay_mult(float value);

  // repeated .caffe.BlockGroupLassoSpec block_group_lasso = 7;
  inline int block_group_lasso_size() const;
  inline void clear_block_group_lasso();
  static const int kBlockGroupLassoFieldNumber = 7;
  inline const ::caffe::BlockGroupLassoSpec& block_group_lasso(int index) const;
  inline ::caffe::BlockGroupLassoSpec* mutable_block_group_lasso(int index);
  inline ::caffe::BlockGroupLassoSpec* add_block_group_lasso();
  inline const ::google::protobuf::RepeatedPtrField< ::caffe::BlockGroupLassoSpec >&
      block_group_lasso() const;
  inline ::google::protobuf::RepeatedPtrField< ::caffe::BlockGroupLassoSpec >*
      mutable_block_group_lasso();

  // optional string regularization_type = 8 [default = ""];
  inline bool has_regularization_type() const;
  inline void clear_regularization_type();
  static const int kRegularizationTypeFieldNumber = 8;
  inline const ::std::string& regularization_type() const;
  inline void set_regularization_type(const ::std::string& value);
  inline void set_regularization_type(const char* value);
  inline void set_regularization_type(const char* value, size_t size);
  ...
  // optional string decay_proto = 9 [default = ""];
  inline bool has_decay_proto() const;
  inline void clear_decay_proto();
  static const int kDecayProtoFieldNumber = 9;
  inline const ::std::string& decay_proto() const;
  inline void set_decay_proto(const ::std::string& value);
  inline void set_decay_proto(const char* value);
  inline void set_decay_proto(const char* value, size_t size);
  inline ::std::string* mutable_decay_proto();
  inline ::std::string* release_decay_proto();
  inline void set_allocated_decay_proto(::std::string* decay_proto);
 ...
 private:
  ...
  inline void set_has_breadth_decay_mult();
  inline void clear_has_breadth_decay_mult();
  inline void set_has_kernel_shape_decay_mult();
  inline void clear_has_kernel_shape_decay_mult();
  inline void set_has_special_shape_decay_mult();
  inline void clear_has_special_shape_decay_mult();
  inline void set_has_regularization_type();
  inline void clear_has_regularization_type();
  inline void set_has_decay_proto();
  inline void clear_has_decay_proto();
  ...
  float lr_mult_;
  float decay_mult_;
  float breadth_decay_mult_;
  float kernel_shape_decay_mult_;
  float special_shape_decay_mult_;
  ::google::protobuf::RepeatedPtrField< ::caffe::BlockGroupLassoSpec > block_group_lasso_;
  ::std::string* regularization_type_;
  ::std::string* decay_proto_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class BlockGroupLassoSpec : public ::google::protobuf::Message {
 public:
  BlockGroupLassoSpec();
  virtual ~BlockGroupLassoSpec();

  BlockGroupLassoSpec(const BlockGroupLassoSpec& from);

  inline BlockGroupLassoSpec& operator=(const BlockGroupLassoSpec& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const BlockGroupLassoSpec& default_instance();

  void Swap(BlockGroupLassoSpec* other);

  // implements Message ----------------------------------------------

  BlockGroupLassoSpec* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const BlockGroupLassoSpec& from);
  void MergeFrom(const BlockGroupLassoSpec& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 xdimen = 1 [default = 1];
  inline bool has_xdimen() const;
  inline void clear_xdimen();
  static const int kXdimenFieldNumber = 1;
  inline ::google::protobuf::uint32 xdimen() const;
  inline void set_xdimen(::google::protobuf::uint32 value);

  // optional uint32 ydimen = 2 [default = 1];
  inline bool has_ydimen() const;
  inline void clear_ydimen();
  static const int kYdimenFieldNumber = 2;
  inline ::google::protobuf::uint32 ydimen() const;
  inline void set_ydimen(::google::protobuf::uint32 value);

  // optional float block_decay_mult = 3 [default = 1];
  inline bool has_block_decay_mult() const;
  inline void clear_block_decay_mult();
  static const int kBlockDecayMultFieldNumber = 3;
  inline float block_decay_mult() const;
  inline void set_block_decay_mult(float value);

  // @@protoc_insertion_point(class_scope:caffe.BlockGroupLassoSpec)
 private:
  inline void set_has_xdimen();
  inline void clear_has_xdimen();
  inline void set_has_ydimen();
  inline void clear_has_ydimen();
  inline void set_has_block_decay_mult();
  inline void clear_has_block_decay_mult();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::uint32 xdimen_;
  ::google::protobuf::uint32 ydimen_;
  float block_decay_mult_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static BlockGroupLassoSpec* default_instance_;
};
// -------------------------------------------------------------------
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  typedef LayerParameter_ConnectivityMode ConnectivityMode;
  static const ConnectivityMode CONNECTED = LayerParameter_ConnectivityMode_CONNECTED;
  static const ConnectivityMode DISCONNECTED_ELTWISE = LayerParameter_ConnectivityMode_DISCONNECTED_ELTWISE;
  static const ConnectivityMode DISCONNECTED_GRPWISE = LayerParameter_ConnectivityMode_DISCONNECTED_GRPWISE;
  static inline bool ConnectivityMode_IsValid(int value) {
    return LayerParameter_ConnectivityMode_IsValid(value);
  }
  static const ConnectivityMode ConnectivityMode_MIN =
    LayerParameter_ConnectivityMode_ConnectivityMode_MIN;
  static const ConnectivityMode ConnectivityMode_MAX =
    LayerParameter_ConnectivityMode_ConnectivityMode_MAX;
  static const int ConnectivityMode_ARRAYSIZE =
    LayerParameter_ConnectivityMode_ConnectivityMode_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  ConnectivityMode_descriptor() {
    return LayerParameter_ConnectivityMode_descriptor();
  }
  static inline const ::std::string& ConnectivityMode_Name(ConnectivityMode value) {
    return LayerParameter_ConnectivityMode_Name(value);
  }
  static inline bool ConnectivityMode_Parse(const ::std::string& name,
      ConnectivityMode* value) {
    return LayerParameter_ConnectivityMode_Parse(name, value);
  }
  ...
  // optional .caffe.LayerParameter.ConnectivityMode connectivity_mode = 12 [default = CONNECTED];
  inline bool has_connectivity_mode() const;
  inline void clear_connectivity_mode();
  static const int kConnectivityModeFieldNumber = 12;
  inline ::caffe::LayerParameter_ConnectivityMode connectivity_mode() const;
  inline void set_connectivity_mode(::caffe::LayerParameter_ConnectivityMode value);
 ...
 private:
  ...
  inline void set_has_phase();
  inline void clear_has_phase();
  inline void set_has_connectivity_mode();
  inline void clear_has_connectivity_mode();
...
class ConvolutionParameter : public ::google::protobuf::Message {
 public:
  ...
  typedef ConvolutionParameter_ConvMode ConvMode;
  static const ConvMode LOWERED_GEMM = ConvolutionParameter_ConvMode_LOWERED_GEMM;
  static const ConvMode LOWERED_CSRMM = ConvolutionParameter_ConvMode_LOWERED_CSRMM;
  static const ConvMode LOWERED_CCNMM = ConvolutionParameter_ConvMode_LOWERED_CCNMM;
  static const ConvMode DIRECT_SCONV = ConvolutionParameter_ConvMode_DIRECT_SCONV;
  static const ConvMode DIRECT_DCONV = ConvolutionParameter_ConvMode_DIRECT_DCONV;
  static inline bool ConvMode_IsValid(int value) {
    return ConvolutionParameter_ConvMode_IsValid(value);
  }
  static const ConvMode ConvMode_MIN =
    ConvolutionParameter_ConvMode_ConvMode_MIN;
  static const ConvMode ConvMode_MAX =
    ConvolutionParameter_ConvMode_ConvMode_MAX;
  static const int ConvMode_ARRAYSIZE =
    ConvolutionParameter_ConvMode_ConvMode_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  ConvMode_descriptor() {
    return ConvolutionParameter_ConvMode_descriptor();
  }
  static inline const ::std::string& ConvMode_Name(ConvMode value) {
    return ConvolutionParameter_ConvMode_Name(value);
  }
  static inline bool ConvMode_Parse(const ::std::string& name,
      ConvMode* value) {
    return ConvolutionParameter_ConvMode_Parse(name, value);
  }
  ...
  // optional .caffe.ConvolutionParameter.ConvMode conv_mode = 21 [default = LOWERED_GEMM];
  inline bool has_conv_mode() const;
  inline void clear_conv_mode();
  static const int kConvModeFieldNumber = 21;
  inline ::caffe::ConvolutionParameter_ConvMode conv_mode() const;
  inline void set_conv_mode(::caffe::ConvolutionParameter_ConvMode value);
...
// optional float breadth_decay = 41 [default = 0];
inline bool SolverParameter::has_breadth_decay() const {
  return (_has_bits_[1] & 0x00000080u) != 0;
}
inline void SolverParameter::set_has_breadth_decay() {
  _has_bits_[1] |= 0x00000080u;
}
inline void SolverParameter::clear_has_breadth_decay() {
  _has_bits_[1] &= ~0x00000080u;
}
inline void SolverParameter::clear_breadth_decay() {
  breadth_decay_ = 0;
  clear_has_breadth_decay();
}
inline float SolverParameter::breadth_decay() const {
  // @@protoc_insertion_point(field_get:caffe.SolverParameter.breadth_decay)
  return breadth_decay_;
}
inline void SolverParameter::set_breadth_decay(float value) {
  set_has_breadth_decay();
  breadth_decay_ = value;
  // @@protoc_insertion_point(field_set:caffe.SolverParameter.breadth_decay)
}

// optional float kernel_shape_decay = 42 [default = 0];
inline bool SolverParameter::has_kernel_shape_decay() const {
  return (_has_bits_[1] & 0x00000100u) != 0;
}
inline void SolverParameter::set_has_kernel_shape_decay() {
  _has_bits_[1] |= 0x00000100u;
}
inline void SolverParameter::clear_has_kernel_shape_decay() {
  _has_bits_[1] &= ~0x00000100u;
}
inline void SolverParameter::clear_kernel_shape_decay() {
  kernel_shape_decay_ = 0;
  clear_has_kernel_shape_decay();
}
inline float SolverParameter::kernel_shape_decay() const {
  // @@protoc_insertion_point(field_get:caffe.SolverParameter.kernel_shape_decay)
  return kernel_shape_decay_;
}
inline void SolverParameter::set_kernel_shape_decay(float value) {
  set_has_kernel_shape_decay();
  kernel_shape_decay_ = value;
  // @@protoc_insertion_point(field_set:caffe.SolverParameter.kernel_shape_decay)
}

// optional float block_group_decay = 43 [default = 0];
inline bool SolverParameter::has_block_group_decay() const {
  return (_has_bits_[1] & 0x00000200u) != 0;
}
inline void SolverParameter::set_has_block_group_decay() {
  _has_bits_[1] |= 0x00000200u;
}
inline void SolverParameter::clear_has_block_group_decay() {
  _has_bits_[1] &= ~0x00000200u;
}
inline void SolverParameter::clear_block_group_decay() {
  block_group_decay_ = 0;
  clear_has_block_group_decay();
}
inline float SolverParameter::block_group_decay() const {
  // @@protoc_insertion_point(field_get:caffe.SolverParameter.block_group_decay)
  return block_group_decay_;
}
inline void SolverParameter::set_block_group_decay(float value) {
  set_has_block_group_decay();
  block_group_decay_ = value;
  // @@protoc_insertion_point(field_set:caffe.SolverParameter.block_group_decay)
}

// optional float special_shape_decay = 44 [default = 0];
inline bool SolverParameter::has_special_shape_decay() const {
  return (_has_bits_[1] & 0x00000400u) != 0;
}
inline void SolverParameter::set_has_special_shape_decay() {
  _has_bits_[1] |= 0x00000400u;
}
inline void SolverParameter::clear_has_special_shape_decay() {
  _has_bits_[1] &= ~0x00000400u;
}
inline void SolverParameter::clear_special_shape_decay() {
  special_shape_decay_ = 0;
  clear_has_special_shape_decay();
}
inline float SolverParameter::special_shape_decay() const {
  // @@protoc_insertion_point(field_get:caffe.SolverParameter.special_shape_decay)
  return special_shape_decay_;
}
inline void SolverParameter::set_special_shape_decay(float value) {
  set_has_special_shape_decay();
  special_shape_decay_ = value;
  // @@protoc_insertion_point(field_set:caffe.SolverParameter.special_shape_decay)
}
...
// optional float breadth_decay_mult = 5 [default = 0];
inline bool ParamSpec::has_breadth_decay_mult() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ParamSpec::set_has_breadth_decay_mult() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ParamSpec::clear_has_breadth_decay_mult() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ParamSpec::clear_breadth_decay_mult() {
  breadth_decay_mult_ = 0;
  clear_has_breadth_decay_mult();
}
inline float ParamSpec::breadth_decay_mult() const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.breadth_decay_mult)
  return breadth_decay_mult_;
}
inline void ParamSpec::set_breadth_decay_mult(float value) {
  set_has_breadth_decay_mult();
  breadth_decay_mult_ = value;
  // @@protoc_insertion_point(field_set:caffe.ParamSpec.breadth_decay_mult)
}

// optional float kernel_shape_decay_mult = 6 [default = 0];
inline bool ParamSpec::has_kernel_shape_decay_mult() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ParamSpec::set_has_kernel_shape_decay_mult() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ParamSpec::clear_has_kernel_shape_decay_mult() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ParamSpec::clear_kernel_shape_decay_mult() {
  kernel_shape_decay_mult_ = 0;
  clear_has_kernel_shape_decay_mult();
}
inline float ParamSpec::kernel_shape_decay_mult() const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.kernel_shape_decay_mult)
  return kernel_shape_decay_mult_;
}
inline void ParamSpec::set_kernel_shape_decay_mult(float value) {
  set_has_kernel_shape_decay_mult();
  kernel_shape_decay_mult_ = value;
  // @@protoc_insertion_point(field_set:caffe.ParamSpec.kernel_shape_decay_mult)
}

// optional float special_shape_decay_mult = 10 [default = 0];
inline bool ParamSpec::has_special_shape_decay_mult() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ParamSpec::set_has_special_shape_decay_mult() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ParamSpec::clear_has_special_shape_decay_mult() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ParamSpec::clear_special_shape_decay_mult() {
  special_shape_decay_mult_ = 0;
  clear_has_special_shape_decay_mult();
}
inline float ParamSpec::special_shape_decay_mult() const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.special_shape_decay_mult)
  return special_shape_decay_mult_;
}
inline void ParamSpec::set_special_shape_decay_mult(float value) {
  set_has_special_shape_decay_mult();
  special_shape_decay_mult_ = value;
  // @@protoc_insertion_point(field_set:caffe.ParamSpec.special_shape_decay_mult)
}

// repeated .caffe.BlockGroupLassoSpec block_group_lasso = 7;
inline int ParamSpec::block_group_lasso_size() const {
  return block_group_lasso_.size();
}
inline void ParamSpec::clear_block_group_lasso() {
  block_group_lasso_.Clear();
}
inline const ::caffe::BlockGroupLassoSpec& ParamSpec::block_group_lasso(int index) const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.block_group_lasso)
  return block_group_lasso_.Get(index);
}
inline ::caffe::BlockGroupLassoSpec* ParamSpec::mutable_block_group_lasso(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.ParamSpec.block_group_lasso)
  return block_group_lasso_.Mutable(index);
}
inline ::caffe::BlockGroupLassoSpec* ParamSpec::add_block_group_lasso() {
  // @@protoc_insertion_point(field_add:caffe.ParamSpec.block_group_lasso)
  return block_group_lasso_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::BlockGroupLassoSpec >&
ParamSpec::block_group_lasso() const {
  // @@protoc_insertion_point(field_list:caffe.ParamSpec.block_group_lasso)
  return block_group_lasso_;
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::BlockGroupLassoSpec >*
ParamSpec::mutable_block_group_lasso() {
  // @@protoc_insertion_point(field_mutable_list:caffe.ParamSpec.block_group_lasso)
  return &block_group_lasso_;
}

// optional string regularization_type = 8 [default = ""];
inline bool ParamSpec::has_regularization_type() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ParamSpec::set_has_regularization_type() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ParamSpec::clear_has_regularization_type() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ParamSpec::clear_regularization_type() {
  if (regularization_type_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    regularization_type_->clear();
  }
  clear_has_regularization_type();
}
inline const ::std::string& ParamSpec::regularization_type() const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.regularization_type)
  return *regularization_type_;
}
inline void ParamSpec::set_regularization_type(const ::std::string& value) {
  set_has_regularization_type();
  if (regularization_type_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    regularization_type_ = new ::std::string;
  }
  regularization_type_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ParamSpec.regularization_type)
}
inline void ParamSpec::set_regularization_type(const char* value) {
  set_has_regularization_type();
  if (regularization_type_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    regularization_type_ = new ::std::string;
  }
  regularization_type_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ParamSpec.regularization_type)
}
inline void ParamSpec::set_regularization_type(const char* value, size_t size) {
  set_has_regularization_type();
  if (regularization_type_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    regularization_type_ = new ::std::string;
  }
  regularization_type_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ParamSpec.regularization_type)
}
inline ::std::string* ParamSpec::mutable_regularization_type() {
  set_has_regularization_type();
  if (regularization_type_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    regularization_type_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ParamSpec.regularization_type)
  return regularization_type_;
}
inline ::std::string* ParamSpec::release_regularization_type() {
  clear_has_regularization_type();
  if (regularization_type_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = regularization_type_;
    regularization_type_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ParamSpec::set_allocated_regularization_type(::std::string* regularization_type) {
  if (regularization_type_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete regularization_type_;
  }
  if (regularization_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ParamSpec.regularization_type)
}

// optional string decay_proto = 9 [default = ""];
inline bool ParamSpec::has_decay_proto() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ParamSpec::set_has_decay_proto() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ParamSpec::clear_has_decay_proto() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ParamSpec::clear_decay_proto() {
  if (decay_proto_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    decay_proto_->clear();
  }
  clear_has_decay_proto();
}
inline const ::std::string& ParamSpec::decay_proto() const {
  // @@protoc_insertion_point(field_get:caffe.ParamSpec.decay_proto)
  return *decay_proto_;
}
inline void ParamSpec::set_decay_proto(const ::std::string& value) {
  set_has_decay_proto();
  if (decay_proto_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    decay_proto_ = new ::std::string;
  }
  decay_proto_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ParamSpec.decay_proto)
}
inline void ParamSpec::set_decay_proto(const char* value) {
  set_has_decay_proto();
  if (decay_proto_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    decay_proto_ = new ::std::string;
  }
  decay_proto_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ParamSpec.decay_proto)
}
inline void ParamSpec::set_decay_proto(const char* value, size_t size) {
  set_has_decay_proto();
  if (decay_proto_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    decay_proto_ = new ::std::string;
  }
  decay_proto_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ParamSpec.decay_proto)
}
inline ::std::string* ParamSpec::mutable_decay_proto() {
  set_has_decay_proto();
  if (decay_proto_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    decay_proto_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ParamSpec.decay_proto)
  return decay_proto_;
}
inline ::std::string* ParamSpec::release_decay_proto() {
  clear_has_decay_proto();
  if (decay_proto_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = decay_proto_;
    decay_proto_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ParamSpec::set_allocated_decay_proto(::std::string* decay_proto) {
  if (decay_proto_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete decay_proto_;
  }
  if (decay_proto) {
    set_has_decay_proto();
    decay_proto_ = decay_proto;
  } else {
    clear_has_decay_proto();
    decay_proto_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.ParamSpec.decay_proto)
}
...
// optional uint32 xdimen = 1 [default = 1];
inline bool BlockGroupLassoSpec::has_xdimen() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BlockGroupLassoSpec::set_has_xdimen() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BlockGroupLassoSpec::clear_has_xdimen() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BlockGroupLassoSpec::clear_xdimen() {
  xdimen_ = 1u;
  clear_has_xdimen();
}
inline ::google::protobuf::uint32 BlockGroupLassoSpec::xdimen() const {
  // @@protoc_insertion_point(field_get:caffe.BlockGroupLassoSpec.xdimen)
  return xdimen_;
}
inline void BlockGroupLassoSpec::set_xdimen(::google::protobuf::uint32 value) {
  set_has_xdimen();
  xdimen_ = value;
  // @@protoc_insertion_point(field_set:caffe.BlockGroupLassoSpec.xdimen)
}

// optional uint32 ydimen = 2 [default = 1];
inline bool BlockGroupLassoSpec::has_ydimen() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BlockGroupLassoSpec::set_has_ydimen() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BlockGroupLassoSpec::clear_has_ydimen() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BlockGroupLassoSpec::clear_ydimen() {
  ydimen_ = 1u;
  clear_has_ydimen();
}
inline ::google::protobuf::uint32 BlockGroupLassoSpec::ydimen() const {
  // @@protoc_insertion_point(field_get:caffe.BlockGroupLassoSpec.ydimen)
  return ydimen_;
}
inline void BlockGroupLassoSpec::set_ydimen(::google::protobuf::uint32 value) {
  set_has_ydimen();
  ydimen_ = value;
  // @@protoc_insertion_point(field_set:caffe.BlockGroupLassoSpec.ydimen)
}

// optional float block_decay_mult = 3 [default = 1];
inline bool BlockGroupLassoSpec::has_block_decay_mult() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BlockGroupLassoSpec::set_has_block_decay_mult() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BlockGroupLassoSpec::clear_has_block_decay_mult() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BlockGroupLassoSpec::clear_block_decay_mult() {
  block_decay_mult_ = 1;
  clear_has_block_decay_mult();
}
inline float BlockGroupLassoSpec::block_decay_mult() const {
  // @@protoc_insertion_point(field_get:caffe.BlockGroupLassoSpec.block_decay_mult)
  return block_decay_mult_;
}
inline void BlockGroupLassoSpec::set_block_decay_mult(float value) {
  set_has_block_decay_mult();
  block_decay_mult_ = value;
  // @@protoc_insertion_point(field_set:caffe.BlockGroupLassoSpec.block_decay_mult)
}
...
// optional .caffe.LayerParameter.ConnectivityMode connectivity_mode = 12 [default = CONNECTED];
inline bool LayerParameter::has_connectivity_mode() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void LayerParameter::set_has_connectivity_mode() {
  _has_bits_[0] |= 0x00000200u;
}
inline void LayerParameter::clear_has_connectivity_mode() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void LayerParameter::clear_connectivity_mode() {
  connectivity_mode_ = 0;
  clear_has_connectivity_mode();
}
inline ::caffe::LayerParameter_ConnectivityMode LayerParameter::connectivity_mode() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.connectivity_mode)
  return static_cast< ::caffe::LayerParameter_ConnectivityMode >(connectivity_mode_);
}
inline void LayerParameter::set_connectivity_mode(::caffe::LayerParameter_ConnectivityMode value) {
  assert(::caffe::LayerParameter_ConnectivityMode_IsValid(value));
  set_has_connectivity_mode();
  connectivity_mode_ = value;
  // @@protoc_insertion_point(field_set:caffe.LayerParameter.connectivity_mode)
}
...
// optional .caffe.ConvolutionParameter.ConvMode conv_mode = 21 [default = LOWERED_GEMM];
inline bool ConvolutionParameter::has_conv_mode() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void ConvolutionParameter::set_has_conv_mode() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ConvolutionParameter::clear_has_conv_mode() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ConvolutionParameter::clear_conv_mode() {
  conv_mode_ = 0;
  clear_has_conv_mode();
}
inline ::caffe::ConvolutionParameter_ConvMode ConvolutionParameter::conv_mode() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.conv_mode)
  return static_cast< ::caffe::ConvolutionParameter_ConvMode >(conv_mode_);
}
inline void ConvolutionParameter::set_conv_mode(::caffe::ConvolutionParameter_ConvMode value) {
  assert(::caffe::ConvolutionParameter_ConvMode_IsValid(value));
  set_has_conv_mode();
  conv_mode_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.conv_mode)
}
...
template <> struct is_proto_enum< ::caffe::LayerParameter_ConnectivityMode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::LayerParameter_ConnectivityMode>() {
  return ::caffe::LayerParameter_ConnectivityMode_descriptor();
}
...
template <> struct is_proto_enum< ::caffe::ConvolutionParameter_ConvMode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::ConvolutionParameter_ConvMode>() {
  return ::caffe::ConvolutionParameter_ConvMode_descriptor();
}
