...
class SGDSolver : public Solver<Dtype> {
 ...
 protected:
  ...
  virtual Dtype GetGroupSparsity(int param_id, bool dimen=true, bool a=true);
  virtual Dtype GetGroupSparsity(int param_id, bool dimen=true, int group=1);
  virtual Dtype GetGroupSparsity(int param_id, int ydimen,int xdimen);
  virtual Dtype GetGroupSparsity(int param_id, int filter_side_size, bool have_group);
